...
def main():
	...
	dst_root = '/home/zeyu/data/MARS/mix_voc_filter'

	MAX_NUM = 50000
	patch_w_ratio_min = 0.4
	patch_w_ratio_max = 0.6
	patch_h_ratio_min = 0.4
	patch_h_ratio_max = 0.6
	...
	for img_counter in xrange(MAX_NUM):
		...
		patch_x = np.random.randint(0, W - patch_w)
		patch_y = np.random.randint(0, H - patch_h)
